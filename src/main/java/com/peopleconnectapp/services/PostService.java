...
import com.peopleconnectapp.repository.PostRepository;
...
public class PostService {
    ...
    public List<Posts> getAllPosts(String categoryName) throws FetchAllPostException {
        List<Posts>  posts;
        String isActive = "Y";
        try {
            ...
            throw new FetchAllPostException(exception,
                    exception.getMessage(),categoryName);
        }
        return posts;
    }
}
